...
class Settings(BaseSettings):
    ...
    # Публичный адрес СЕРВИСА (ссылки отписки, сниппет в админке). Без хвостового /.
    public_base_url: str = "https://groster.skypath.fun"

    # Адрес МАГАЗИНА — куда ведут кнопки «в магазин» в письмах. Отдельно от сервиса:
    # домен витрины меняется независимо, а вести покупателя на домен рассылок нельзя.
    shop_url: str = "https://groster.me"
