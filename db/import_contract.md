...
## Секция `top5`
**Полная замена** среза подборки (старые позиции очищаются целиком). `position` — 1..30
(в письмо уходит до 30 товаров; сколько именно — «Товаров в письме» в настройках сценария).
